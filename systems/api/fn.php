          ...
          if ($getVariants["items"]) { 
                ...
                foreach($getVariants["items"] AS $id_filter => $array){
                  ...
                  if($getFilter){
                      ...
                      $out[$getFilter->ads_filters_position] = [ "name" => $ULang->tApp( html_entity_decode($getFilter->ads_filters_name) , [ "table" => "uni_ads_filters", "field" => "ads_filters_name" ] ), "value" => implode(",", $value) ];
                  }
